const imageField = document.querySelector("#profileImg");
...
function upload(files) {
    ...
    $.ajax({ 
        type: 'POST',
        url: '/fileUpload', // URL на метод действия Upload контроллера HomeController
        data:  formData,
        processData: false,
        contentType: false,
        dataType:"json",
        ...
        success: function (data) {
            if (data.fileUploaded != false) {
                imageField.setAttribute('src', "/asset/img/user/"+data.fileUploaded);
            }
